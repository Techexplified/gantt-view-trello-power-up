...
export default function Sidebar({ board, activeBoardId, onSelectBoard, onLogout }) {
                ...
                {boards.map((b) => (
                  <li key={b.id}>
                    <button
                      style={{
                        ...styles.boardItem,
                        ...(b.id === activeBoardId ? styles.boardItemActive : {}),
                      }}
...
function PIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      ...
      <text x="6" y="17" fontSize="12" fontWeight="700" fill="#00d084" fontFamily="monospace">P</text>
    </svg>
  );
}
